            ...
            >
                <section className="courses-content">
                    <nav className="content-tabs">
                        ...
                        <button className="tab-btn active">Challenges</button>
                    </nav>

                    <header className="content-header">
                        <h2 className="main-title challenge-title">Learning Path</h2>
                        <p className="main-subtitle">Complete challenges to earn XP and unlock new content</p>
                    </header>
                    ...
                    <div className="challenges-grid">
                        <article className="challenge-card">
                            ...
                            <div className="challenge-reward">
                                <span className="reward-label">Reward:</span> 250 XP + "First Steps" Badge.
                            </div>
                        </article>

                        <article className="challenge-card locked">
                            <div className="challenge-header">
                                <div className="challenge-icon-wrapper">
                                    <img src="img/locked.png" alt="Locked" className="icon-locked" />
